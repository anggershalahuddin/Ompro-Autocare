  ...
  return (
    <section class="bg-[#E6EAF8] md:grid md:place-content-center h-full">
      <div class="mx-auto w-full max-w-screen-4xl overflow-hidden px-10 py-10 sm:px-12 sm:py-10 lg:px-16 lg:py-10 ">
        ...
        <div className="gap-5 flex flex-col md:flex-row items-start justify-evenly">
          <div className="bg-white rounded-xl py-5 px-8 shadow-md shadow-gray-300 h-full w-full">
            ...
            <div className="text-xs md:text-base text-wrap xl:text-nowrap">
